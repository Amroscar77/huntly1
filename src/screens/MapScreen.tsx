            ...
            <div className="bg-white rounded-3xl p-4 shadow-2xl border border-outline-variant/20 flex gap-4 items-center relative">
              ...
              <div className="flex-grow min-w-0">
                <div className="flex items-center gap-1 mb-1">
                  ...
                  {selectedItem.imageUrl && <Verified size={12} className="text-success" />}
                </div>
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar">
          {filteredSubmissions.length > 0 ? (
            filteredSubmissions.map(s => (
              ...
              >
                {s.imageUrl && (
                  <div className="absolute top-2 right-2 bg-success/10 text-success px-2 py-0.5 rounded-full text-[8px] font-black uppercase tracking-tighter flex items-center gap-0.5">
