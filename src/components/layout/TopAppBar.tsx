...
export default function TopAppBar() {
  ...
  const avatarUrl = user?.photoURL || `https://ui-avatars.com/api/?name=${encodeURIComponent(user?.displayName || 'U')}&background=ca5cdd&color=fff&size=80`;
    ...
    <header className="bg-surface sticky top-0 z-50 border-b border-surface-container">
      <div className="flex items-center justify-between px-6 py-4 w-full max-w-7xl mx-auto">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="font-headline text-xl font-black tracking-tighter text-primary leading-tight">Huntly</h1>
            <div className="flex items-center gap-1 text-tertiary font-bold text-[10px] uppercase tracking-widest">
              <Coins size={10} />
